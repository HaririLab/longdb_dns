...
def select(request):
	if request.method == 'POST':
		...
		if form.is_valid() and form_snp.is_valid():
			fields=[]
	...
	return render(request, 'select.html',{'form':form,'options_day1':options_day1,'options_bat':options_bat,'options_img':options_img,'form_snp':form_snp})
